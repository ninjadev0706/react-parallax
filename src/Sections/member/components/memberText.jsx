  ...
  return (
    <div className="relative xl:w-[200%] md:-ml-[150px] lg:-ml-[175px] xl:-ml-[100px]">
      <div>
        ...
        <p className="leading-[1.3] text-[32px] md:text-[40px] lg:text-[45px] xl:text-[55px] 2xl:text-[65px] font-black mb-[20px] 2xl:mb-[55px] mt-[20px] 2xl:mt-[55px] font-drukBold">
          All paid in ETH.
        </p>
