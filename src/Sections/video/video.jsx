    ...
    <div className="md:mt-[600px] mb-[50px]">
      ...
      <div className="pb-[40px] px-[10%]">
        <div className="mb-[40px]">
          <p className="font-drukBold text-center m-auto leading-[1.3] 2xl:text-[65px] xl:text-[55px] md:text-[40px] text-[28px] font-black md:max-w-[900px]">
            Built for creators by Creators.
          </p>
        </div>
        <div className="app-wrap w-[100%] m-auto">
