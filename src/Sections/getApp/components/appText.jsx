  ...
  return (
    <div className="md:w-7/12">
      <div className="leading-[60px] mb-[40px]">
        <p className="font-drukBold leading-[1] 2xl:text-[55px] md:text-[40px] text-[30px]">No Ads.</p>
        <p className="font-drukBold leading-[1] 2xl:text-[55px] md:text-[40px] text-[30px]">No Rugs.</p>
        <p className="hidden md:block font-drukBold leading-[1] 2xl:text-[55px] md:text-[40px] text-[30px]">You in control.</p>
