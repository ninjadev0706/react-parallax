  ...
  return (
    <div className="flex justify-center px-[10%] md:hidden md:w-6/12">
      <div className="relative items-center">
        <div className="md:video-container w-[250px] rounded-[20px] overflow-hidden">
        ...
        <img
          ...
          alt=" "
          className="absolute w-[250px] top-[-30px]"
        />
        {/* <img
        ...
        /> */}
        <div className="absolute max-w-[120px] top-[550px] right-[-20px]">
