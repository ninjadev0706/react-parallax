...
const HeroText = () => {
  return (
    <div className="2xl:max-w-[650px] xl:max-w-[500px] lg:max-w-[360px]">
      <p className="font-drukBold pl-[20px] md:pl-[0] leading-[1] 2xl:text-[70px] xl:text-[50px] lg:text-[38px] md:text-[35px] text-[32px] font-black mb-[30px] 2xl:mb-[20px] mt-[30px] md:mt-0">
